...
// Google Play requires one that works without the app. Everything it promises
// mirrors the privacy policy (30 days, what is kept) and the Terms (no refund,
// subscription cancelled in the store). Deletion is a manual process today:
// the request arrives by email and a developer carries it out.
export const en: DataDeletionContent = {
  lang: "en",
  label: "English",
  pageTitle: "Data Deletion Request | Geofast: Battle of Nations",
  metaDescription:
    "How to delete your Geofast: Battle of Nations account and personal data, what is deleted, what is kept, and how long it takes.",
  ...
  request: {
    title: "Request deletion now",
    text: "The button opens an email to us with the request already written. Fill in your account details and send it. If you have no email app on this device, write to contact@geofastgames.com with the same details.",
  ...
  sections: [
    {
      ...
      blocks: [
        {
          type: "p",
          text: "You can have your *Geofast: Battle of Nations* account and the personal data linked to it deleted at any time, wherever you live. You do not need to give a reason. This page explains what is deleted, what we keep and why, what to do before you ask, and how to ask.",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Within 30 days of a confirmed request, we delete from our live systems:",
        },
        {
          type: "ul",
          items: [
            ...
            "chat messages and direct messages still in our live database;",
            "your push notification token;",
            "the analytics events linked to your account in our live database.",
          ],
        },
        {
          type: "p",
          text: "When it is done, we confirm by email. Deletion is permanent and cannot be undone.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Records that had already left the live database for our archive before your request, as described under [how long we keep data](/privacy#retention) in the Privacy Policy.",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "**Think about linked devices.** The account disappears from every device it was linked to, not only the one you write from.",
          ],
        },
      ],
    },
