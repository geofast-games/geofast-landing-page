  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "我們不刪除不活躍的帳戶。您可以隨時透過我們的[資料刪除頁面](/datadeletion)刪除您的帳戶。刪除是永久性的，包括您的進度、虛擬貨幣和物品。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "您可以隨時解除安裝遊戲以停止遊玩，也可以透過我們的[資料刪除頁面](/datadeletion)刪除您的帳戶。刪除帳戶會永久移除您的進度、虛擬貨幣和物品；這些均不予退款。",
        },
        {
          type: "p",
